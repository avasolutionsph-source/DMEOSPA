...
class RoomManager {
    ...
    updateTimerDisplays() {
        ...
        // NOTE: We now use startDirectTimer() for advance bookings instead of updateTimerDisplays()
        // This section is disabled to prevent timer conflicts
        console.log('⏭️ [TIMER-UPDATE] Skipping advance booking timers - using startDirectTimer() instead');
